...
void resize_function__StraightToPoint_Goal__dest(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StraightToPoint_Goal_message_member_array[1] = {
  {
    ...
    resize_function__StraightToPoint_Goal__dest  // resize(index) function pointer
  }
};
...
void resize_function__StraightToPoint_Result__final(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StraightToPoint_Result_message_member_array[1] = {
  {
    ...
    resize_function__StraightToPoint_Result__final  // resize(index) function pointer
  }
};
...
void resize_function__StraightToPoint_Feedback__current_location(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StraightToPoint_Feedback_message_member_array[1] = {
  {
    ...
    resize_function__StraightToPoint_Feedback__current_location  // resize(index) function pointer
  }
};
